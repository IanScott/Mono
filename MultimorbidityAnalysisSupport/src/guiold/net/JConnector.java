...
public class JConnector extends JPanel {
    ...
    protected void calculateLine() {
        ...
        int sx = (int)rSource.getCenterX();
        int sy = (int)rSource.getCenterY();
        
        int dx = (int)rDest.getCenterX();
        int dy = (int)rDest.getCenterY();
        ...
        if (xIntersect) {
            ...
            //line = new ConnectLine(new Point(sx, sy), new Point(dx, dy), ConnectLine.LINE_TYPE_RECT_2BREAK, ConnectLine.LINE_START_VERTICAL, lineArrow);
